...
@section('nav-title', 'Edit Tutor')
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form class="validate-form" action="{{route('admin.tutor.update',$tutor->id)}}" method="POST">
                    @csrf
                    ...
                    <div class="card ">
                        <div class="card-header card-header-rose card-header-icon">
                            ...
                            <h5 class="card-title">Edit Tutor</h5>
                        </div>
                        <div class="card-body ">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('first_name') is-invalid @enderror" id="name" required="true" name="first_name" value="{{ $tutor->first_name ?? ''}}">
                                        @error('first_name')
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('last_name') is-invalid @enderror" id="last_name" required="true" name="last_name" value="{{$tutor->last_name ?? ''}}">
                                        @error('last_name')
                                        <span class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" required="true" name="email" value="{{$tutor->email ?? ''}}">
                                        @error('email')
                                        <span class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" required="true" class="form-control @error('phone') is-invalid @enderror" id="phone"  name="phone" value="{{$tutor->tutor->phone ?? ''}}">
                                        @error('phone')
                                        <span class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" class="form-control @error('hourly_rate') is-invalid @enderror" id="hourly_rate" readonly  name="hourly_rate" required="true" value="{{$tutor->tutor->hourly_rate ?? ''}}">
                                        @error('hourly_rate')
                                        <span class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="time_zone" class="form-control time_zone_select shadow-none rounded-sm select2 @error('time_zone') is-invalid @enderror">
                                            ...
                                            <option value='US/Mountain' selected>(UTC-07:00) Mountain Time (US &amp; Canada)</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="location_id" class="form-control time_zone_select shadow-none rounded-sm select2 @error('time_zone') is-invalid @enderror">
                                            ...
                                            @foreach($locations as $item)
                                                <option value="{{ $item->id }}" @if($item->id==$tutor->tutor->location_id) selected @endif>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('bio') is-invalid @enderror" id="bio"  name="bio" maxlength="100" required="true">{{$tutor->tutor->bio ?? ''}}</textarea>
                                        @error('bio')
                                        <span class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" id="bio"  name="description" required="true">{{$tutor->tutor->description ?? ''}}</textarea>
                                        @error('description')
                                            <span class="invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>

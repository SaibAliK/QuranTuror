                ...
                <form class="validate-form" action="{{ route('admin.testimonial.save') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('address') is-invalid @enderror" id="address" required="true" name="address" value="{{ $item->address }}">
                                        @error('address')
                                            <span class="invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                       ...
                                       <textarea id="review" rows="6" class="form-control" name="review">{{ $item->review }}</textarea>
                                        @error('review')
                                            <span class="invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
                        ...
                        <div class="card-footer mt-4">
                            <button type="submit" class="btn btn-rose">Saved</button>
                        </div>
                    </div>
                </form>
            </div>

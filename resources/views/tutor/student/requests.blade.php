    ...
    <div class="card ">
        ...
        <div class="card-body">
            <div class="col-lg-12 mb-3 text-center  ">
                <h2 class="text-center has-line text-dark line-primary">Student Requests</h2>
            </div>
                        ...
                        <table class="table w-100 display" >
                            ...
                            @foreach($pending as $request)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="javascript:void(0);" data-href="{{route('tutor.student.request.approve',['id'=>$request->id])}}" type="button"  rel="tooltip" class="btn btn-success rounded-circle btn-round approve_button" data-original-title="Approve Request" title="Request Approve">
                                            <i class="fa fa-check-circle"></i>
                                        </a>
                                        <a href="javascript:void(0);" data-href="{{route('tutor.student.request.cancel',['id'=>$request->id])}}"   rel="tooltip" class="btn btn-danger rounded-circle btn-round cancel_button" data-original-title="Cancel Request" title="Request Cancel" >
                    ...
                    <div class="col-lg-12 p-3">
                        <table class="table w-100 display" >
                            ...
                            @foreach($approved as $approve)
                                <tr>
                                    <td>{{$approve->student->FullName}}</td>
